...
export const ClueView = (clueCount) => {
  return (
    <>
      <div className="absolute flex bottom-[1rem] left-[1rem] w-[10rem] p-0 bg-black bg-opacity-75 text-white text-lg z-10 justify-center items-center rounded-xl">
        <div>
...
export const LifeView = (lifeCount) => {
  return (
    <>
      <div className="absolute flex bottom-[1rem] left-[12.5rem] w-[10rem] pr-3 bg-black bg-opacity-75 text-white text-lg z-10 justify-center items-center rounded-xl">
        <div>
