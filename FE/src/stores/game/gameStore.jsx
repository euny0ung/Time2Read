...
export const useChallengedArticleStore = create(
  devtools(
    persist(
      ...
      { name: 'challenged-article', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const useGameResultStore = create(
  devtools(
    persist(
      ...
      { name: 'game-result', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const useGameModalStore = create(
  devtools(
    persist(
      ...
      { name: 'game-modal', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const useGameItemStore = create(
  devtools(
    persist(
      ...
      { name: 'game-item', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const useVisibilityStore = create(
  devtools(
    persist(
      ...
      { name: 'visibility', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const checkCollidedStore = create(
  devtools(
    persist(
      ...
      { name: 'collided', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const checkGameYearStore = create(
  devtools(
    persist(
      ...
      { name: 'game-year', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
...
export const useResultDataStore = create(
  devtools(
    persist(
      ...
      { name: 'result-data', storage: createJSONStorage(() => sessionStorage) },
    ),
  ),
);
